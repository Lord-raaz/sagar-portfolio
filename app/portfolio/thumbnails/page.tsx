...
const thumbnailDesigns = [
  {
    ...
    description: 'High-energy gaming thumbnail with bold colors and dynamic typography designed to increase click-through rates',
  ...
  },
  {
    ...
    description: 'Clean and professional tech thumbnail featuring product focus and clear value proposition',
    category: 'Technology',
    ctr: '9.8%',
    type: 'YouTube Thumbnail',
  },
  {
    ...
    description: 'Educational thumbnail with clear hierarchy and engaging visual elements to attract learners',
    category: 'Education',
    ctr: '11.2%',
    type: 'YouTube Thumbnail',
  },
  {
    ...
    description: 'Eye-catching entertainment thumbnail with vibrant colors and compelling visual storytelling',
  ...
  },
  {
    ...
    title: 'Lifestyle Thumbnail Design',
    description: 'Lifestyle thumbnail with aesthetic appeal and clear messaging designed for maximum engagement',
    category: 'Lifestyle',
    ctr: '10.7%',
    type: 'YouTube Thumbnail',
  },
